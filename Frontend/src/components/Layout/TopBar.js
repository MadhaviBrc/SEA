                            ...
                            <div class="d-flex order-lg-2 ml-auto">
                                ...
                                <div class="dropdown profile-dropdown">
                                    <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                        <span>
                                            <img src="../static/assets/images/users/16.jpg" alt="img" class="avatar avatar-md brround"/>
                                        </span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                        ...
                                        <Link class="dropdown-item d-flex" to="/login">
                                            <svg class="header-icon mr-3" x="1008" y="1248" viewBox="0 0 24 24" height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
                        ...
                        <nav class="horizontalMenu clearfix">
                            <ul class="horizontalMenu-list">
                                <li aria-haspopup="true">
                                    ...
                                    <ul class="sub-menu">
                                        <li aria-haspopup="true"><Link to="/index">Dashboard 01</Link></li>
                                        <li aria-haspopup="true"><Link to="/index2">Dashboard 02</Link></li>
                                    </ul>
                                </li>
                                <li aria-haspopup="true">
                                    <a href="#" class="sub-icon">
                                    ...
                                    <ul class="sub-menu">
                                        <li aria-haspopup="true"><Link to="/student">Student</Link></li>
                                        <li aria-haspopup="true"><Link to="/parent">Parent</Link></li>
                                        <li aria-haspopup="true"><Link to="/teacher">Teacher</Link></li>
                                        <li aria-haspopup="true"><Link to="/users">Users</Link></li>
                                    </ul>
                                </li>
